...
class StackedCTABGAN3():
    ...
    def __init__(self,
        ...
        self.synthesizer = StackedCTABGANSynthesizer(epochs = epochs)
    ...
    def generate_samples(self):
        ...
        sample_first_gen, sample_stacked = self.synthesizer.sample(len(self.raw_df)) 
        sample_df_first_gen = self.data_prep.inverse_prep(sample_first_gen)
        sample_df_stacked = self.data_prep.inverse_prep(sample_stacked)
        return sample_df_first_gen, sample_df_stacked
